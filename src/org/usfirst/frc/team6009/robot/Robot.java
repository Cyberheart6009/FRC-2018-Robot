...
public class Robot extends IterativeRobot { 
	...
	SpeedController leftFront, leftBack, rightFront, rightBack, gripper, elevator, climber; 
	...
	/** 
 	...
 	public void teleopPeriodic() { 
		...
		if (limitSwitchDown.get()) {  //|| limitSwitchDown.get())// 
 			if (driver.getRawAxis(5) < 0) {
 				elevator.set(0);
 			} 
 			else {
 ...
 */
 		...
 		//gripper arms don't go too far apart (right side of analog stick is positive, left side is negative, positive makes arms go bigger)
